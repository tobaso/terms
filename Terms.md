...
8.  サービス利用料は、運営会社が、本条1項による代金の代理受領に関する手数料として徴収するものであり、売上金額に対して料率20%を乗じた金額とします。ただし、サービス利用料は、運営会社が開催するイベントやキャンペーン等により、条件を満たした募集者に対して、別途定める当該イベント・キャンペーン等の規約に従い異なる取り扱いをすることがあります。
9.  振込手数料は、300円とします。
